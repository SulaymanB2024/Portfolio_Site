...
const briefNotes = [
  'Use the brief for technical SEO, crawl evidence, analytics, or source-backed research requests.',
            ...
            <div className="flex min-h-[58svh] flex-col justify-between py-7 md:min-h-[64svh] lg:min-h-0 lg:py-10">
              ...
              <div>
                ...
                <p className="mt-8 max-w-xl text-sm leading-relaxed text-canvas/58 md:text-base">
                  For technical SEO, search visibility, crawl evidence, analytics, or source-backed research. Start with the direct email or send a short brief.
                </p>
