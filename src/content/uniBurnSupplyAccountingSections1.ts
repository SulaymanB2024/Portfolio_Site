...
export const UNI_BURN_SUPPLY_ACCOUNTING_SECTIONS_1: ArticleSection[] = [
    ...
    "figures": [
      {
        ...
        "caption": "August 5, 2026 reported tracker snapshot. The 100M treasury transfer is separated from the unclassified recurring-and-other residual; source inputs and arithmetic are in the downloadable package."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "paragraphs": [
      "A complete classified export of every UNI transfer to every recognized burn address was not available from the dashboard snapshot. The model therefore uses two reported windows and labels their provenance separately.",
      "Method 1: cumulative residual proxy.",
      "The August draft recorded Burnalytics displaying 108,025,224 UNI at recognized burn addresses as of August 5, 2026 at 18:15 UTC. Subtracting the known 100 million treasury transfer leaves:",
      ...
      "Different observation windows and wallet coverage can produce different rates. This release does not independently reclassify the 90-day transfer set or verify a later v4 activation. Neither annualization is a stable forecast. [8]",
      "The two reported-input scenarios at the cutoff were therefore 13.26 million to 15.93 million UNI per year.",
    ...
    "table": {
      "caption": "Two annualized scenarios from reported historical inputs",
      "columns": [
        "Measure",
        "Raw observation",
        "Annualized UNI burn",
    ...
    "figures": [
      {
        ...
        "caption": "Annualized scenarios from reported August inputs, compared with a 20M UNI treasury distribution schedule. These are token quantities, not forecasts, new issuance, or measured market sales."
      }
    ]
  }
];
