...
export const MARKET_THESES: MarketThesis[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      { label: 'Crawler policy sources', href: '/research/ai-search-crawler-policy-sources.csv' },
    ],
    content: [
      ...
      'The operating model I use for this site is simple: allow public discovery agents on public reference pages, keep stale URLs redirected, publish an XML sitemap, expose an llms.txt reference file, and keep every major claim tied to visible public support. That is not a promise of rankings or AI citations. It is a disciplined way to make the site legible to search engines, retrieval systems, and human reviewers at the same time.',
    ],
  },
  {
