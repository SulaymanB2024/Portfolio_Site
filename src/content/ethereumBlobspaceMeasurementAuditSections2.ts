...
export const ETHEREUM_BLOBSPACE_SECTIONS_2: ArticleSection[] = [
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "The central conclusion is insensitive to plausible illustrative adjustments. These scenarios are not observed miss-rate estimates. Their purpose is to show that scheduled-versus-produced-slot choice does not turn one-third BPO2 target utilization into saturation."
    ],
    "table": {
      ...
      "columns": [
        ...
        "July 2026 BPO2 target utilization at 30k–35k/day"
      ],
      "rows": [
        [
          "0%",
