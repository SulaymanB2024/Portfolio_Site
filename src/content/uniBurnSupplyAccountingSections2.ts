...
export const UNI_BURN_SUPPLY_ACCOUNTING_SECTIONS_2: ArticleSection[] = [
  {
    ...
    "paragraphs": [
      ...
      "The draft’s cited August 1 analysis reported operating-wallet accumulation and did not identify market deployment in its observation window. Its underlying wallet export is not available in this release, so no measured sell-through is inferred from that report. The scenario model tests assumptions instead. [8]",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "At 50% sell-through, the modeled sink remained positive by 3.26 million to 5.93 million UNI per year. This does not select 50% as an observed or preferred assumption; actual recipient disposition is not established here."
    ],
    "table": {
    ...
    "figures": [
      {
        ...
        "caption": "Conditional no-new-mint model: reported annualized burn proxy minus 20M UNI times assumed sell-through. Positive values represent modeled removal; this is not measured net exchange buying."
      }
    ]
  },
  {
