...
export const SOFTWARE_BUYOUT_COHORT_ARTICLE: ResearchArticle = {
  ...
  sections: [
    ...
    {
      id: 'deal-by-deal-control-inventory',
      title: 'The 25-deal control inventory',
      paragraphs: [
        'These are the 25 records in the downloadable cohort, reproduced here so the classification can be read alongside the method. The evidence cutoff remains August 17, 2026; publication of this table is not a new verification of each transaction.',
        'Read each outcome with its control summary and classification note. Headline values follow mixed announcement conventions and are shown in billions of U.S. dollars. They are not sponsor equity contributions, current marks, or realized proceeds. The underlying primary transaction ledger is not included in the public package.',
      ],
      table: {
        caption: 'Published cohort classifications at August 17, 2026. Source: the downloadable row-level cohort; mixed headline value definitions, USD billions.',
        columns: ['Company', 'Announcement year', 'Headline value (USD bn)', 'Sponsor group', 'Outcome category', 'Control at the cutoff', 'Classification note'],
        rows: [
          ["RealPage", "2020", "10.2", "Thoma Bravo", "continuing sponsor ownership", "Private; sponsor control continues", "Headline transaction value"],
          ["Pluralsight", "2020", "3.5", "Vista Equity Partners", "completed creditor transfer", "Lenders became owners through restructuring", "Control transfer is not a sponsor realization"],
          ["Endurance International Group", "2020", "3.0", "Clearlake Capital; Siris Capital", "continuing sponsor ownership", "Operates as Newfold Digital under sponsor ownership", "Rebranding does not change control classification"],
          ["Proofpoint", "2021", "12.3", "Thoma Bravo", "continuing sponsor ownership", "Private; sponsor control continues", "No clean control exit identified"],
          ["McAfee", "2021", "14.0", "Advent International-led investor group", "continuing sponsor ownership", "Private; sponsor consortium control continues", "Liquidity and refinancing are separate from control exit"],
          ["Inovalon", "2021", "7.3", "Nordic Capital; Insight Partners-led group", "continuing sponsor ownership", "Private; sponsor group remains in control", "Added after cohort verification correction"],
          ["Mimecast", "2021", "5.8", "Permira", "continuing sponsor ownership", "Private; sponsor control continues", "No clean control exit identified"],
          ["Cloudera", "2021", "5.3", "KKR; Clayton Dubilier & Rice", "continuing sponsor ownership", "Private; sponsor control continues", "Debt and dividend events do not establish realization"],
          ["Stamps.com / Auctane", "2021", "6.6", "Thoma Bravo", "continuing sponsor ownership", "Private; operates as Auctane under sponsor ownership", "Name change does not change classification"],
          ["Medallia", "2021", "6.4", "Thoma Bravo", "continuing sponsor ownership", "Private at cutoff; sponsor and creditor developments classified separately", "Public evidence does not establish sponsor return"],
          ["Cornerstone OnDemand", "2021", "5.2", "Clearlake Capital", "continuing sponsor ownership", "Private; sponsor control continues", "No clean control exit identified"],
          ["Bottomline Technologies", "2021", "2.6", "Thoma Bravo", "continuing sponsor ownership", "Private; sponsor control continues", "No clean control exit identified"],
          ["QAD", "2021", "2.0", "Thoma Bravo", "continuing sponsor ownership", "Private; sponsor control continues", "No clean control exit identified"],
          ["Talend", "2021", "2.4", "Thoma Bravo", "continuing sponsor ownership", "Combined with other sponsor-controlled software assets", "Combination is not a clean sponsor realization"],
          ["CoreLogic / Cotality", "2021", "5.9", "Stone Point Capital; Insight Partners", "continuing sponsor ownership", "Private; sponsor ownership continues after rebrand", "Value follows cohort headline convention"],
          ["Citrix Systems", "2022", "16.5", "Vista Equity Partners; Evergreen Coast Capital", "continuing sponsor ownership", "Operates within Cloud Software Group; original sponsor control not shown as fully realized", "Debt restructuring is not automatically an equity exit"],
          ["Zendesk", "2022", "10.2", "Hellman & Friedman; Permira", "continuing sponsor ownership", "Private; sponsor consortium control continues", "No clean control exit identified"],
          ["Coupa Software", "2022", "8.0", "Thoma Bravo", "continuing sponsor ownership", "Private; sponsor control continues", "No clean control exit identified"],
          ["Anaplan", "2022", "10.7", "Thoma Bravo", "continuing sponsor ownership", "Private; sponsor control continues", "Uses announced headline value; final terms discussed in report"],
          ["SailPoint", "2022", "6.9", "Thoma Bravo", "partial liquidity", "Public listing completed but sponsor retained voting control at cutoff", "IPO is a route to exit not a completed control exit"],
          ["Avalara", "2022", "8.4", "Vista Equity Partners", "continuing sponsor ownership", "Private; sponsor control continues", "No clean control exit identified"],
          ["CDK Global", "2022", "8.3", "Brookfield Business Partners", "continuing sponsor ownership", "Private; sponsor control continues", "Operational events do not determine sponsor return"],
          ["KnowBe4", "2022", "4.6", "Vista Equity Partners", "continuing sponsor ownership", "Private; sponsor control continues", "Secondary or continuation liquidity is classified separately"],
          ["Ping Identity", "2022", "2.8", "Thoma Bravo", "continuing sponsor ownership", "Private; combined with ForgeRock under sponsor control", "Combination does not remove sponsor control"],
          ["ForgeRock", "2022", "2.3", "Thoma Bravo", "continuing sponsor ownership", "Merged into Ping Identity under sponsor control", "Regulatory close and integration are not sponsor realization"]
        ],
      },
    },
    {
