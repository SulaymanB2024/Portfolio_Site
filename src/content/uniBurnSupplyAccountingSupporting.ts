...
export const UNI_BURN_SUPPLY_ACCOUNTING_RESOURCES: ArticleResource[] = [
  ...
  },
  {
    ...
    "description": "Primary and secondary source register, original research dates, and release verification limits.",
    "format": "CSV"
  },
  {
    "label": "Claim ledger",
    "href": "/research/uni-burn-claim-ledger.csv",
    "description": "Key claims labeled as primary-source mechanics, reported historical inputs, derived calculations, or assumptions.",
    "format": "CSV"
  },
  {
...
export const UNI_BURN_SUPPLY_ACCOUNTING_SOURCES: ArticleSource[] = [
  ...
  {
    "label": "Uniswap governance — v4 vote reference (activation not verified here)",
