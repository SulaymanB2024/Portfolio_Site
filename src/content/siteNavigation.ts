...
export const primaryNav: SiteNavItem[] = [
  { label: 'Work', href: '/work', description: 'A complete project-family ledger plus six flagship case studies, with clear ownership, status, visibility, and scope.' },
  { label: 'Atlas', href: '/atlas', description: 'Technical SEO crawl-analysis software with a public sample and candid capability status.' },
  { label: 'Research', href: '/research', description: 'Four connected clusters for AI systems, search systems, technical SEO, and market models.' },
...
export const utilityNav: SiteNavItem[] = [
  { label: 'SEO Audit Method', href: '/method', description: 'Technical SEO audit services, process, deliverables, and post-change checks.' },
