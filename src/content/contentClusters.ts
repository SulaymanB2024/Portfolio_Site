...
export const CONTENT_CLUSTERS: readonly ContentCluster[] = [
  ...
  },
  {
    ...
    description:
      'Source-led work on ownership, capital structures, operating economics, forecasts, and decision models with assumptions and recommendation boundaries kept visible.',
    directAnswer:
