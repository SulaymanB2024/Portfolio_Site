...
export const SOLID_ROCKET_MOTOR_CAPACITY_ARTICLE: ResearchArticle = {
  ...
  "conclusion": {
    ...
    "content": "Tactical and selected medium-class supply should broaden by 2029, but announced factories do not establish qualified alternatives. Large and strategic markets remain more dependent on incumbents. Count named programs with multiple qualified sources, accepted deliveries at rate, and independent upstream supply paths."
  },
  ...
  "resources": [
    {
      "label": "Complete Markdown edition",
      "href": "/research/us-solid-rocket-motor-capacity-audit.md",
      "description": "The complete article with figures, tables, methodology, and linked source register; research cutoff August 16, 2026.",
      "format": "MD"
    },
    {
