...
export const TEXAS_TOLL_ARTICLE_DESCRIPTION = 'Most Texas toll roads are publicly owned. See who owns each system, which private concessions operate lanes, and where toll revenue and billing sit.';
export const TEXAS_TOLL_ARTICLE_DATE = '2026.07.11';
export const TEXAS_TOLL_ARTICLE_UPDATED = '2026.07.23';
