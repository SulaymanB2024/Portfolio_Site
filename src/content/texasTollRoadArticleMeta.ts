...
export const TEXAS_TOLL_ARTICLE_SEO_TITLE = 'Who Owns Texas Toll Roads? Owners, Operators & Concessions';
export const TEXAS_TOLL_ARTICLE_DESCRIPTION = 'Texas toll-road ownership tracker: compare public authorities, operators, private concessions, regions, billing agencies, and cited primary sources.';
export const TEXAS_TOLL_ARTICLE_DATE = '2026.07.11';
export const TEXAS_TOLL_ARTICLE_UPDATED = '2026.09.03';
