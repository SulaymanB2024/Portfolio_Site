...
export const RESEARCH_ARTICLES: ResearchArticle[] = [
  ...
  },
  {
    ...
    evidenceBoundary:
      'This guide documents published crawler controls as verified on July 24, 2026. A robots.txt rule expresses policy; it does not secure private content, authenticate a bot, or prove indexing, ranking, training exclusion, or answer-system citation.',
    metrics: [
      { label: 'Agents compared', value: '8 USER AGENTS' },
      { label: 'Policies', value: '2 COPY-READY' },
      { label: 'Last verified', value: '2026.07.24' },
      { label: 'Primary artifact', value: 'ROBOTS POLICY' },
    ],
    sources: [
      { label: 'OpenAI crawler documentation', href: 'https://developers.openai.com/api/docs/bots', lastVerified: '2026.07.24' },
      {
      ...
      { label: 'Perplexity crawler documentation', href: 'https://docs.perplexity.ai/docs/resources/perplexity-crawlers', lastVerified: '2026.07.24' },
      { label: 'Google robots.txt introduction and limitations', href: 'https://developers.google.com/search/docs/crawling-indexing/robots/intro', lastVerified: '2026.07.24' },
      { label: 'OpenAI OAI-SearchBot IP ranges', href: 'https://openai.com/searchbot.json', lastVerified: '2026.07.24' },
      { label: 'OpenAI GPTBot IP ranges', href: 'https://openai.com/gptbot.json', lastVerified: '2026.07.24' },
      { label: 'OpenAI ChatGPT-User IP ranges', href: 'https://openai.com/chatgpt-user.json', lastVerified: '2026.07.24' },
      { label: 'Anthropic bot IP ranges', href: 'https://claude.com/crawling/bots.json', lastVerified: '2026.07.24' },
      { label: 'PerplexityBot IP ranges', href: 'https://www.perplexity.ai/perplexitybot.json', lastVerified: '2026.07.24' },
      { label: 'Perplexity-User IP ranges', href: 'https://www.perplexity.ai/perplexity-user.json', lastVerified: '2026.07.24' },
    ],
    content: [
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          caption: 'Published AI crawler roles and robots.txt behavior, last verified July 24, 2026',
          columns: ['Provider', 'Exact token', 'Mode', 'robots.txt', 'Operator note', 'Verified'],
          rows: [
            ['OpenAI', 'OAI-SearchBot', 'Search', 'Supported', 'Answer-discovery token', '2026-07-24'],
            ['OpenAI', 'GPTBot', 'Model development', 'Supported', 'Training opt-out token', '2026-07-24'],
            ['OpenAI', 'ChatGPT-User', 'User request', 'May not apply', 'Not an automatic-index token', '2026-07-24'],
            ['Anthropic', 'Claude-SearchBot', 'Search', 'Honored', 'Claude search token', '2026-07-24'],
            ['Anthropic', 'ClaudeBot', 'Model development', 'Honored', 'Training token', '2026-07-24'],
            ['Anthropic', 'Claude-User', 'User request', 'Honored', 'User-opened URL token', '2026-07-24'],
            ['Perplexity', 'PerplexityBot', 'Search', 'Supported', 'Search token; not training', '2026-07-24'],
            ['Perplexity', 'Perplexity-User', 'User request', 'Generally ignored', 'User-requested fetch token', '2026-07-24'],
          ],
        },
      },
      {
      ...
      {
        id: 'review-history',
        title: 'Review history and scope changes',
        paragraphs: [
          'The guide is rechecked against first-party crawler documentation before its reviewed date changes. A new provider token is added only when it changes the search, model-development, or user-triggered policy choices covered here.',
        ],
        table: {
          caption: 'Crawler-policy guide maintenance log',
          columns: ['Reviewed', 'What changed', 'Scope decision'],
          rows: [
            ['2026-07-24', 'Reverified all eight documented tokens and provider IP-range references.', 'OpenAI OAI-AdsBot remains outside this search, training, and user-fetch matrix because it is limited to submitted ads.'],
            ['2026-07-14', 'Added exact provider roles, copy-ready directives, first-party sources, and log-verification guidance.', 'Eight search, model-development, and user-triggered agents included.'],
          ],
        },
      },
    ],
