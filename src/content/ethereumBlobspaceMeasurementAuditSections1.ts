...
export const ETHEREUM_BLOBSPACE_SECTIONS_1: ArticleSection[] = [
  {
    ...
    "paragraphs": [
      ...
      "Estimate: July non-zero bytes obtained by applying the cumulative rounded occupancy rate to the published 30,000–35,000/day range."
    ],
    "table": {
      ...
      "rows": [
        ...
        ["How much BPO2 target capacity is used at 30,000 blobs/day?", "30,000 submitted blobs/day", "100,800 target blob-slots/day", "29.76%", "About seven of every ten target opportunities are unused at the low end of the July range."],
        ...
        ["How much BPO2 maximum capacity is used?", "30,000–35,000", "151,200 maximum blob-slots/day", "19.84%–23.15%", "The July range is roughly one-fifth to one-quarter of the hard per-block envelope."],
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "A cumulative utilization calculation cannot divide all historical blobs by the July 14-blob target. That would retroactively assign BPO2 capacity to periods when the protocol exposed three or six target slots. The correct denominator is regime-weighted.",
    ...
    "figures": [{
      ...
      "alt": "Step chart of Ethereum blob target and maximum by protocol regime, with the July 30,000 to 35,000 blob daily range shown as a band.",
      "label": "Figure 1 / Capacity regime schedule",
      "width": 2286,
      "height": 1249,
      "caption": "Figure 1. Ethereum mainnet blob target and maximum by protocol regime. The shaded July-demand band converts 30,000–35,000 blobs/day into 4.167–4.861 blobs per scheduled slot. The band sits above Dencun’s old target of three and below every later target."
    }]
  },
  {
  ...
  {
    "id": "july-bpo2-utilization-is-about-one-third-of-target",
    "title": "July 2026 BPO2 utilization is about one-third of target",
    "paragraphs": [
      "BPO2 targets 14 blobs per slot and allows 21. With 12-second slots, a fully scheduled day contains 7,200 slots. The BPO2 envelopes are therefore:",
      ...
      "Estimate applies the cumulative, rounded 86.94% occupancy rate to the published July range. It is not a directly observed daily usage series.",
    ...
    "table": {
      "caption": "July 2026 BPO2 utilization is about one-third of target",
      "columns": ["July operator range", "Blobs per scheduled slot", "BPO2 target utilization", "BPO2 maximum utilization", "Raw bytes/day", "Estimated non-zero bytes/day*"],
    ...
    "figures": [{
      ...
      "alt": "Horizontal bar chart comparing posted-blob byte occupancy, historical target and maximum utilization, and July BPO2 utilization ranges.",
      "label": "Figure 2 / Denominator map",
      "width": 2287,
      "height": 1336,
      "caption": "Figure 2. Four percentages that are all correct. Posted-blob byte occupancy is 86.94%; full-history target utilization is 50.54%; full-history maximum utilization is 31.315%; July BPO2 target and maximum utilization are ranges of 29.76%–34.72% and 19.84%–23.15%. The chart is a denominator map, not a single time series."
    }]
  }
];
