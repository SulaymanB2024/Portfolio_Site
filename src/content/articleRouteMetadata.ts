...
export const ARTICLE_ROUTE_METADATA: ArticleRouteMetadata[] = [
  {
    ...
    "indexable": true,
    "staticSummary": "Ethereum blobspace utilization depends on the denominator. The July 2026 inputs report 86.94% occupancy inside submitted blobs, while the operator range corresponds to 29.76–34.72% of scheduled BPO2 target capacity. These are historical measurements of different quantities. Ethereum blobspace is simultaneously 86.94% full and roughly 30–35% utilized under the BPO2 target in the July snapshot. Neither statement is wrong. They divide different things.",
  ...
  },
  {
    ...
    "dateModified": "2026.09.06",
    "indexable": true,
    "staticSummary": "UNI burn supply accounting requires separate contract, dead-address, treasury, and market-float ledgers. The August 2026 reported inputs imply 891.975 million UNI outside recognized burn addresses, while the contract accounting denominator remains one billion. Neither quantity establishes circulating supply or market sales. At the August 2026 research cutoff, UNI’s contract-supply denominator was 1 billion. The draft’s reported burn-address balance implied a smaller dead-address-adjusted quantity.",
    "image": "/images/social/og-research.png"
  },
  {
    "kind": "research",
  ...
  },
  {
    ...
    "aliases": [],
    "title": "When Does a Data Center Become Infrastructure?",
    "seoTitle": "When Data Centers Become Infrastructure",
    "seoDescription": "A source-led guide to the power rights, tenant commitments, guarantees, construction milestones, and residual value that make a hyperscale data center financeable.",
    "date": "2026.09.06",
    "dateModified": "2026.09.06",
    "indexable": true,
    "staticSummary": "A data center becomes an infrastructure cash-flow asset when repayment depends mainly on durable operating payments and residual rights, rather than on the probability that the campus can still be built, powered, accepted, and refinanced. A hyperscale campus is not one asset moving through a generic construction timeline. It is a sequence of risk objects: generic land, entitled land, a power position, tenant-backed development, financed construction, an energized facility, accepted operating cash flow, a permanently financed security, a platform, and eventually a residual or re-leasing asset.",
    "image": "/images/social/og-research.png"
  },
  {
    "kind": "research",
    ...
    "aliases": [],
    "title": "How Many Indie App Developers Make $1,000 a Month?",
    "seoTitle": "Independent App Income Distribution: Who Clears $1,000/Month?",
    "seoDescription": "See modeled indie app income ranges by denominator, test subscriber economics, explore selected cases, and download the full report, workbook, data, and code.",
    "date": "2026.09.06",
    "dateModified": "2026.09.06",
    "indexable": true,
    "staticSummary": "About one in six developers behind serious independent app attempts are modeled to generate at least $1,000 in current monthly gross app revenue across their portfolios. The 15.4% central estimate has an 8.4% to 25.0% plausible interval. This July 2026 model is not an app-store census. The honest answer is not a single percentage. “Independent app,” “developer,” “revenue,” and even “makes” can each point to a different denominator or economic layer. Counting every listing in an app store produces a radically lower success rate than counting products that survived launch, implemented monetization, and received a meaningful commercial effort. Counting a developer’s portfolio produces a higher rate than asking whether any one app clears the line. Measuring one good month produces a higher rate than requiring the result to persist.",
    "image": "/images/social/og-research.png"
  },
  {
    "kind": "research",
