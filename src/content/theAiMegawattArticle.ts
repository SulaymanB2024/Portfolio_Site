...
export const THE_AI_MEGAWATT_ARTICLE: ResearchArticle = {
  ...
  conclusion: {
    ...
    content: 'For a homogeneous GB300 reference design, 1 GW of total facility nameplate supports about 402,574 installed B300 GPUs in the reference case and roughly 355,819–434,856 across the stated engineering sensitivities. One gigawatt of IT nameplate supports about 460,948. One gigawatt of requested interconnection capacity supports no defensible installed-fleet estimate without additional evidence. The useful discipline is not a better single ratio. It is a capacity dictionary that keeps grid, facility, IT, rack, installed fleet, average draw, computational utilization, and commercial utilization separate.',
  },
