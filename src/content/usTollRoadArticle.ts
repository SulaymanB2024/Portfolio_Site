...
export const US_TOLL_ROAD_ARTICLE: InvestmentMemo = {
  ...
  conclusion: {
    ...
    content: "The useful question is not whether a toll road is simply public or private. Ask who holds legal title, who operates the lanes, who sends the bill, who receives toll revenue, who bears demand risk, who owns the project company, who finances it, and what returns to government at expiry. The answer can change at one layer while the road name stays the same."
  },
