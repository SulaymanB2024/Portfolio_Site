...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2029925600300015634
...
const sketch: P5SketchFactory = (instance) => {
  ...
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(9).stroke(w,96);for(t+=PI/45,i=3e4;i--;)a(i%2*3)};
};
