...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2024121022929363391
...
const sketch: P5SketchFactory = (instance) => {
  ...
  a=(y,o=mag(k=cos(y*5)*(y<11?21:11),e=y/8-13)/6)=>point((q=k*2+49+cos(y)/k+k*cos(y/2)*(1+sin(o*4-e/2-t)))*sin(c=o/1.5-e/5-t/8+i%3*8)+200,230+q*cos(c)-79*sin(c/2))
