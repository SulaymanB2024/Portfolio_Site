...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2083571114543046898
...
const sketch: P5SketchFactory = (instance) => {
  ...
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(9).stroke(w,116);for(t+=PI/60,i=1e4;i--;)a(i/265)};
};
