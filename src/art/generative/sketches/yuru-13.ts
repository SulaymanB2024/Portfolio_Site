...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2030288158626353226
...
const sketch: P5SketchFactory = (instance) => {
  ...
  a=(y,o=mag(k=cos(y*7)*(y<19?sin(t/8+y*9)*31:9),e=y/8-13)/6)=>point((q=59+cos(y)/k+k/o*4*(5/o/e*9+sin(o*3-e*9-t)))*sin(c=o/2-e/6-t/8+i%2*3)+200,200+(q+70)*cos(c))
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(6).stroke(w,96);for(t+=PI/30,i=2e4;i--;)a(i/600)};
};
