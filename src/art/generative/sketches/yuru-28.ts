...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2022526453779435912
...
const sketch: P5SketchFactory = (instance) => {
  ...
  a=(y,o=mag(k=cos(y*9)*(y<5?sin(t/8+y)*35:11),e=y/8-13)/6)=>point((q=k*y/19+49+k*sin(y)*sin(o*2-e/5-t))*sin(c=o/3-e/5-t/8+i%4*8)-79*cos(c/3)+200,200+(q+70)*cos(c))
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(6).stroke(w,96);for(t+=PI/30,i=2e4;i--;)a(i/500)};
};
