...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2022524457508835641
...
const sketch: P5SketchFactory = (instance) => {
  ...
  a=(y,o=mag(k=cos(y*9)*(y<9?sin(t+y)*28:11),e=y/8-13)/6)=>point((q=k*y/15+79+k*sin(y)*(1+sin(o*4-e-t*8)))*sin(c=o/2-e/4-t+i%2*15)+70*sin(c/3)+200,200+q/.7*cos(c))
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(6).stroke(w,96);for(t+=PI/240,i=2e4;i--;)a(i/500)};
};
