...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/1979111285951467874
...
const sketch: P5SketchFactory = (instance) => {
  ...
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(9).stroke(w,96);for(t+=PI/60,i=3e4;i--;)a(i/799)};
};
