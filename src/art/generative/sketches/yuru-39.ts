...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/1979110452538831111
...
const sketch: P5SketchFactory = (instance) => {
  ...
  a=(y,d=mag(k=5*cos(i/48),e=5*cos(y/9))**2/59+4)=>point((q=k*(3+2*sin(d*d-t+i%4))-3*sin(atan2(k,e)*9)-~(i&1)*40)*sin(c=d-t/9+i%5*5+i%2*2)+200,(q+80)*cos(c)+200)
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(9).stroke(w,96);for(t+=PI/40,i=3e4;i--;)a(i/999)};
};
