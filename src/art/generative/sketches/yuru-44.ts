...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/1973405239878492467
...
const sketch: P5SketchFactory = (instance) => {
  ...
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(6,96).stroke(w,46);for(t+=PI/90,i=4e4;i--;)a(i%200,i/200)};
};
