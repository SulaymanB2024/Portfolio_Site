...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2030289783755546783
...
const sketch: P5SketchFactory = (instance) => {
  ...
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(9).stroke(w,96);for(t+=PI/30,i=2e4;i--;)a(i/600)};
};
