...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/2021238125285036136
...
const sketch: P5SketchFactory = (instance) => {
  ...
  a=(y,o=mag(k=cos(y*5)*(y<11?21:11),e=y/8-13)/6)=>point((q=k*2+49+cos(19/k)+k*cos(y/2)*(1+sin(o*4-e*2-t)))*sin(c=o/1.5-e/5-t/8+i%3*8)+200,200+q*cos(c)-79*sin(c/3))
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(6).stroke(w,96);for(t+=PI/45,i=2e4;i--;)a(i/500)};
};
