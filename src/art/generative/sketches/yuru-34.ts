...
/**
 * Instance-mode port of https://x.com/yuruyurau/status/1999900774143607224
...
const sketch: P5SketchFactory = (instance) => {
  ...
  a=(d=mag(k=5*cos(i/49)*cos(i/3690),e=i/984-12)**2/99+1)=>stroke(w,36+3/cos(t+e)).point(k*(4+sin(d*18-t*2+i%3*2))-5*sin(atan2(k,e)*9)+30*sin(c=d-t/18+i%3*4)+200,80*sin(c-d)+d*79)
  t=0,instance.draw =$=>{t||createCanvas(w=400,w);background(9);for(t+=PI/30,i=3e4;i--;)a()};
};
