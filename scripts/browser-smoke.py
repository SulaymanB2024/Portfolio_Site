...
paths += ['/work'] + ['/work/' + slug for slug in ['internshipdeadlines', 'project-delta', 'payrollpro', 'no-limit-artemis', 'mandatearc', 'jane-street-puzzle', 'internship-aggregator-engine', '1-800-operator', 'dropkit-sui-ticketing', 'sezzle-fundamental-model', 'coal-price-forecasting-framework', 'race-the-case-decision-model']]
...
assert len(results) == len(paths) * 2 + 13, results
