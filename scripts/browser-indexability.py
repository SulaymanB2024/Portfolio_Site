...
for slug in ['internshipdeadlines', 'project-delta', 'payrollpro', 'no-limit-artemis', 'mandatearc', 'jane-street-puzzle', 'internship-aggregator-engine', '1-800-operator', 'dropkit-sui-ticketing', 'sezzle-fundamental-model', 'coal-price-forecasting-framework']:
...
assert len(results) == 94, results
print('Passed 94 initial-document checks across desktop/mobile, no JavaScript, failed entry, and failed route chunks.')
